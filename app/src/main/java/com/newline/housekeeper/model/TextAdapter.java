...
public class TextAdapter extends ArrayAdapter<String> {
	...
	public TextAdapter(Context context, List<String> listData, int sId, int nId) {
		super(context, R.string.nocontent, listData);
		mContext = context;
		mListData = listData;
	...
	public TextAdapter(Context context, String[] arrayData, int sId, int nId) {
		super(context, R.string.nocontent, arrayData);
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (mString.contains(mContext.getString(R.string.all)))
			view.setText(mContext.getString(R.string.all));
		else
